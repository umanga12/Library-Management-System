...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="Kathmandu"/>Kathmandu<div style="margin-left:80px"><input type="radio" name="branch" value="{Pokhara}"/>Pokhara<input type="radio" name="branch" value="Butwal"/>Butwal</div>
            </div>   
